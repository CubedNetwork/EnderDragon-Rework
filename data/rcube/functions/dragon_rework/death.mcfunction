...
execute unless data storage rcube:dragon_rework {previously_defeated:true} run data modify storage rcube:dragon_rework previously_defeated set value true
