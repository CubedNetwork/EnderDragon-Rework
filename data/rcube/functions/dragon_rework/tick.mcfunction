...
execute unless entity @e[tag=dragon_rework.dragonInit,type=minecraft:ender_dragon] if data storage rcube:dragon_rework {alive:true} unless entity @a[advancements={rcube:dragon_rework/kill_dragon=true}] run function rcube:dragon_rework/death
# Set state to dead
