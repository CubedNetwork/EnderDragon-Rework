...
# Players / Mobs
execute unless entity @s[type=minecraft:arrow] store result score @s rcube_dragonRework.UUID0 run data get entity @s UUID[0]
execute unless entity @s[type=minecraft:arrow] store result score @s rcube_dragonRework.UUID1 run data get entity @s UUID[1]
execute unless entity @s[type=minecraft:arrow] store result score @s rcube_dragonRework.UUID2 run data get entity @s UUID[2]
execute unless entity @s[type=minecraft:arrow] store result score @s rcube_dragonRework.UUID3 run data get entity @s UUID[3]