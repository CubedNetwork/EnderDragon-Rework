...
execute if score $arrow_beam.loop rcube_dragonRework.store matches ..0 run schedule function rcube:dragon_rework/attacks/miniboss/abilities/arrow_beam/loop 12t append
