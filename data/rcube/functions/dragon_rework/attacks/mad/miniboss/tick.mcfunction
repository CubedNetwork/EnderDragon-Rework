...
# Heal
execute unless entity @s[nbt={HandItems:[{id:"minecraft:totem_of_undying",Count:1b}]}] unless entity @s[tag=dragon_rework.minibossMAD] run effect give @s instant_damage 1 9 true

# #####################
# Buff Gear
# #####################
# Bow
execute unless entity @s[nbt={HandItems:[{id:"minecraft:totem_of_undying",Count:1b}]}] unless entity @s[tag=dragon_rework.minibossMAD] run data merge entity @s {HandItems:[{id:"minecraft:bow",tag:{display:{Name:'["",{"text":"The Bow of Old","italic":false,"color":"dark_purple"}]'},Enchantments:[{lvl:8,id:"minecraft:power"},{lvl:4,id:"minecraft:punch"},{lvl:1,id:"minecraft:flame"},{lvl:1,id:"minecraft:infinity"}],Unbreakable:1,HideFlags:4},Count:1b}]}
...
# #####################
# Tag
execute unless entity @s[nbt={HandItems:[{id:"minecraft:totem_of_undying",Count:1b}]}] run tag @s add dragon_rework.minibossMAD
