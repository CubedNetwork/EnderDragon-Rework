...
# Effects
# #####################
execute if entity @s[nbt={HandItems:[{},{id:"minecraft:totem_of_undying",Count:true}]}] run effect give @s speed 2 2 true
execute if entity @s[nbt={HandItems:[{},{id:"minecraft:totem_of_undying",Count:true}]}] run effect give @s strength 2 1 true
execute if entity @s[nbt={HandItems:[{},{id:"minecraft:totem_of_undying",Count:true}]}] run effect give @s resistance 2 0 true
...
# Heal
execute if entity @s[nbt=!{HandItems:[{},{id:"minecraft:totem_of_undying",Count:true}]}] unless entity @s[tag=dragon_rework.minibossMAD] run data merge entity @s {Health:150f}

# Fix totem visual glitch
execute if entity @s[nbt=!{HandItems:[{},{id:"minecraft:totem_of_undying",Count:true}]}] unless entity @s[tag=dragon_rework.minibossMAD] run item replace entity @s weapon.offhand with air
...
# #####################
# Bow
execute if entity @s[nbt=!{HandItems:[{},{id:"minecraft:totem_of_undying",Count:true}]}] unless entity @s[tag=dragon_rework.minibossMAD] run data merge entity @s {HandItems:[{id:"minecraft:bow",tag:{display:{Name:'["",{"text":"The Bow of Old","italic":false,"color":"dark_purple"}]'},Enchantments:[{lvl:8,id:"minecraft:power"},{lvl:4,id:"minecraft:punch"},{lvl:1,id:"minecraft:flame"},{lvl:1,id:"minecraft:infinity"}],Unbreakable:true,HideFlags:4},Count:true},{}]}

# Armour + Red Enderman Eyes
execute if entity @s[nbt=!{HandItems:[{},{id:"minecraft:totem_of_undying",Count:true}]}] unless entity @s[tag=dragon_rework.minibossMAD] run data merge entity @s {ArmorItems:[{id:"minecraft:leather_boots",tag:{display:{color:1908001},Enchantments:[{lvl:7,id:"minecraft:protection"},{lvl:255,id:"minecraft:blast_protection"},{lvl:255,id:"minecraft:fire_protection"},{lvl:255,id:"minecraft:projectile_protection"},{lvl:6,id:"minecraft:thorns"},{lvl:255,id:"minecraft:feather_falling"}],Unbreakable:true},Count:true},{id:"minecraft:leather_leggings",tag:{display:{color:1908001},Enchantments:[{lvl:7,id:"minecraft:protection"},{lvl:255,id:"minecraft:blast_protection"},{lvl:255,id:"minecraft:fire_protection"},{lvl:255,id:"minecraft:projectile_protection"},{lvl:6,id:"minecraft:thorns"}],Unbreakable:true,HideFlags:4},Count:true},{id:"minecraft:leather_chestplate",tag:{display:{color:1908001},Enchantments:[{lvl:7,id:"minecraft:protection"},{lvl:255,id:"minecraft:blast_protection"},{lvl:255,id:"minecraft:fire_protection"},{lvl:255,id:"minecraft:projectile_protection"},{lvl:6,id:"minecraft:thorns"}],Unbreakable:true,HideFlags:4},Count:true},{id:"minecraft:player_head",tag:{Enchantments:[{lvl:7,id:"minecraft:protection"},{lvl:255,id:"minecraft:blast_protection"},{lvl:255,id:"minecraft:fire_protection"},{lvl:255,id:"minecraft:projectile_protection"},{lvl:6,id:"minecraft:thorns"}],SkullOwner:{Id:[I;1658453630,1781350791,-1964493527,-2123315747],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYmJjZjNmNTc4NzE5NmQyNTZjMTA0ZmZmYWU4ZTUyNjUyNDIyMjJlMjEzOGE1N2ExNjY2YzE1YjVmNmM4N2I5OCJ9fX0="}]}}},Count:true}]}
...
# #####################
# Tag
execute if entity @s[nbt=!{HandItems:[{},{id:"minecraft:totem_of_undying",Count:true}]}] run tag @s add dragon_rework.minibossMAD
