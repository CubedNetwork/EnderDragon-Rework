...
execute if entity @s[scores={rcube.dragonRework_phase=3..},tag=!dragon_rework.minibossMAD] run scoreboard players set @s rcube.dragonRework_phase 1
execute if entity @s[scores={rcube.dragonRework_phase=4..},tag=dragon_rework.minibossMAD] run scoreboard players set @s rcube.dragonRework_phase 1