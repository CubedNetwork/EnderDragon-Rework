...
tag @e[tag=dragon_rework.enderman.ANGRY_1] add dragon_rework.enderman.ANGRY
tag @e[tag=dragon_rework.enderman.ANGRY_2] add dragon_rework.enderman.ANGRY
tag @e[tag=dragon_rework.enderman.ANGRY_3] add dragon_rework.enderman.ANGRY
...
# clear tags
tag @e[tag=dragon_rework.enderman.ANGRY] remove dragon_rework.enderman.ANGRY_1
tag @e[tag=dragon_rework.enderman.ANGRY] remove dragon_rework.enderman.ANGRY_2
tag @e[tag=dragon_rework.enderman.ANGRY] remove dragon_rework.enderman.ANGRY_3
tag @e[tag=dragon_rework.enderman.ANGRY] remove dragon_rework.enderman.ANGRY
tag @e[tag=dragon_rework.enderman.VICTIM] remove dragon_rework.enderman.VICTIM_1
tag @e[tag=dragon_rework.enderman.VICTIM] remove dragon_rework.enderman.VICTIM_2
tag @e[tag=dragon_rework.enderman.VICTIM] remove dragon_rework.enderman.VICTIM_3
tag @e[tag=dragon_rework.enderman.VICTIM] remove dragon_rework.enderman.VICTIM