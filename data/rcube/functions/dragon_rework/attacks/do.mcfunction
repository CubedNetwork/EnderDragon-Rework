...
execute if entity @s[scores={rcube_dragonRework.phase=3}] in minecraft:the_end at @s run function rcube:dragon_rework/attacks/normal/raining_fireballs
execute if entity @s[scores={rcube_dragonRework.phase=4}] in minecraft:the_end at @s run function rcube:dragon_rework/attacks/normal/perch
...
execute if entity @s[scores={rcube_dragonRework.phase=8..},tag=dragon_rework.MAD] run scoreboard players set @s rcube_dragonRework.phase 1
