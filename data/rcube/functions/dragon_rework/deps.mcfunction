...
# Set state
execute if predicate rcube:api/damage_taken/installed if data storage rcube:api/damage_taken root{installed:true} if score $ver.damage_taken.major rcube_dragonRework.deps matches 0 if score $ver.damage_taken.game.major rcube_dragonRework.deps matches 20 if score $ver.damage_taken.game.patch rcube_dragonRework.deps matches 1 run data modify storage rcube:dragon_rework root.dependencies append value {module:"damage_taken",installed:true}
...
# Set state
execute if predicate rcube:api/player_name/installed if data storage rcube:api/player_name root{installed:true} if score $ver.player_name.major rcube_dragonRework.deps matches 0 if score $ver.player_name.game.major rcube_dragonRework.deps matches 20 if score $ver.player_name.game.patch rcube_dragonRework.deps matches 1 run data modify storage rcube:dragon_rework root.dependencies append value {module:"player_name",installed:true}
...
# Set state
execute if predicate rcube:api/px_calc/installed if data storage rcube:api/px_calc root{installed:true} if score $ver.px_calc.major rcube_dragonRework.deps matches 0 if score $ver.px_calc.game.major rcube_dragonRework.deps matches 20 if score $ver.px_calc.game.patch rcube_dragonRework.deps matches 1 run data modify storage rcube:dragon_rework root.dependencies append value {module:"px_calc",installed:true}
...
# Set state
execute if predicate rcube:api/scoreboard_rank/installed if data storage rcube:api/scoreboard_rank root{installed:true} if score $ver.scoreboard_rank.major rcube_dragonRework.deps matches 0 if score $ver.scoreboard_rank.game.major rcube_dragonRework.deps matches 20 if score $ver.scoreboard_rank.game.patch rcube_dragonRework.deps matches 1 run data modify storage rcube:dragon_rework root.dependencies append value {module:"scoreboard_rank",installed:true}
