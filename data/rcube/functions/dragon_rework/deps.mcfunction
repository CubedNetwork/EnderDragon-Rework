...
execute if predicate rcube:_core/installed if data storage rcube:api/core {installed:true} run data modify storage rcube:dragon_rework root.dependencies append value {module:"core",installed:true}
...
execute if predicate rcube:centre_string/installed if data storage rcube:api/centre_string {installed:true} run data modify storage rcube:dragon_rework root.dependencies append value {module:"centre_string",installed:true}
...
execute if predicate rcube:damage_dealt/installed if data storage rcube:api/damage_dealt {installed:true} run data modify storage rcube:dragon_rework root.dependencies append value {module:"damage_dealt",installed:true}
...
execute if predicate rcube:player_name/installed if data storage rcube:api/player_name {installed:true} run data modify storage rcube:dragon_rework root.dependencies append value {module:"player_name",installed:true}
...
execute if predicate rcube:px_calc/installed if data storage rcube:api/px_calc {installed:true} run data modify storage rcube:dragon_rework root.dependencies append value {module:"px_calc",installed:true}
...
execute if predicate rcube:scoreboard_rank/installed if data storage rcube:api/scoreboard_rank {installed:true} run data modify storage rcube:dragon_rework root.dependencies append value {module:"scoreboard_rank",installed:true}
