...
execute if entity @s[tag=dragon_rework.MAD] run execute positioned 0. 0 0. run summon fireball ^ ^ ^.1 {HasVisualFire:0b,ExplosionPower:2,power:[0.0,-1.0,0.0],Tags:["dragon_rework.fireball","dragon_rework.fireball.0"]}
