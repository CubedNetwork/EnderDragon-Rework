...
# Init data
data remove storage rcube:api/centre_string dependencies
...
execute if predicate rcube:px_calc/installed if data storage rcube:api/px_calc {installed:true,version:{this:"0.3.0",minecraft:"1.20.1"}} run data modify storage rcube:api/centre_string private.dependencies append value {module:"core",installed:true}
