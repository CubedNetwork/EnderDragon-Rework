...
execute if entity @e[tag=dragon_rework.music.phase1,type=minecraft:ender_dragon] at @s run playsound rcube:dragon_rework.phase1 music @s ~ ~ ~ 1 1
...
execute if entity @e[tag=dragon_rework.music.MAD,type=minecraft:ender_dragon] at @s run playsound rcube:dragon_rework.phase2 music @s ~ ~ ~ 1 1
