...
# Set MAD state - check
execute if entity @s[nbt=!{HandItems:[{},{id:"minecraft:totem_of_undying",Count:1b}]}] unless entity @s[tag=dragon_rework.minibossMAD] run scoreboard players set $miniboss.MAD rcube_dragonRework.store 1
...
# #####################
# Bow
execute if score $miniboss.MAD rcube_dragonRework.store matches 1 unless entity @s[tag=dragon_rework.minibossMAD] run data merge entity @s {HandItems:[{id:"minecraft:bow",tag:{display:{id:'["",{"text":"The Bow of Old","italic":false,"color":"dark_purple"}]'},Enchantments:[{lvl:8,id:"minecraft:power"},{lvl:4,id:"minecraft:punch"},{lvl:1,id:"minecraft:flame"},{lvl:1,id:"minecraft:infinity"}],Unbreakable:true,HideFlags:4},Count:1b},{}]}
