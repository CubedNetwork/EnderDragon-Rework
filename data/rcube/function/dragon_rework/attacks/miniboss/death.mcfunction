...
execute unless entity @e[tag=dragon_rework.miniboss] at @e[tag=dragon_rework.miniboss.loc] run playsound minecraft:entity.explode hostile @a[predicate=rcube:dragon_rework/end_centre] ~ ~ ~ 7
