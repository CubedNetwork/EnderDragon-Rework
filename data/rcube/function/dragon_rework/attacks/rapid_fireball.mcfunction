...
kill @e[tag=dragon_rework.fireball_rapid]
...
schedule function rcube:dragon_rework/sch/fireball/rapid/launch 40t append
...
execute if entity @s[tag=dragon_rework.UNHINGED] run schedule function rcube:dragon_rework/sch/fireball/rapid/launch 70t append

# Remove tag
schedule function rcube:dragon_rework/sch/fireball/rapid/clear_tag 80t append
