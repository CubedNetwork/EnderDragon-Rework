...
execute as @e[tag=dragon_rework.dragonInit] at @s if entity @s[tag=dragon_rework.MAD,tag=!dragon_rework.UNHINGED] facing entity @a[tag=dragon_rework.fireball_rapid.VICTIM.temp] eyes run summon fireball ^ ^ ^.1 {HasVisualFire:false,ExplosionPower:3,acceleration_power:0.5d,Tags:["dragon_rework.fireball","dragon_rework.fireball_rapid","dragon_rework.fireball_rapid.temp","dragon_rework.remove"]}
execute as @e[tag=dragon_rework.dragonInit] at @s if entity @s[tag=dragon_rework.UNHINGED] facing entity @a[tag=dragon_rework.fireball_rapid.VICTIM.temp] eyes run summon fireball ^ ^ ^.1 {HasVisualFire:false,ExplosionPower:4,acceleration_power:0.5d,Tags:["dragon_rework.fireball","dragon_rework.fireball_rapid","dragon_rework.fireball_rapid.temp","dragon_rework.remove"]}
...
# Set Motion
data modify entity @e[tag=dragon_rework.fireball_rapid.temp,limit=1] Motion set from entity @e[tag=dragon_rework.fireball_rapid.dir_tmp,limit=1] Pos
