...
execute as @e[tag=dragon_rework.dragonInit] at @s if entity @s[tag=!dragon_rework.MAD,tag=!dragon_rework.UNHINGED] facing entity @a[tag=dragon_rework.fireball_strong.VICTIM.temp] eyes run summon fireball ^ ^ ^.1 {HasVisualFire:false,ExplosionPower:3b,acceleration_power:0.5d,Tags:["dragon_rework.fireball_strong.temp","dragon_rework.fireball","dragon_rework.fireball_strong","dragon_rework.remove"],Item:{id:"minecraft:dragon_egg",Count:1b}}
execute as @e[tag=dragon_rework.dragonInit] at @s if entity @s[tag=dragon_rework.MAD,tag=!dragon_rework.UNHINGED] facing entity @a[tag=dragon_rework.fireball_strong.VICTIM.temp] eyes run summon fireball ^ ^ ^.1 {HasVisualFire:false,ExplosionPower:5b,acceleration_power:0.5d,Tags:["dragon_rework.fireball_strong.temp","dragon_rework.fireball","dragon_rework.fireball_strong","dragon_rework.remove"],Item:{id:"minecraft:dragon_egg",Count:1b}}
...
# Set Motion
data modify entity @e[tag=dragon_rework.fireball_strong.temp,limit=1] Motion set from entity @e[tag=dragon_rework.fireball_strong.dir_tmp,limit=1] Pos
