...
execute as @e[tag=dragon_rework.dragonInit] run function rcube:api/damage_taken/check
...
# Check damaged players (Utilises module 'damage_taken')
execute as @a[scores={rcubeAPI_damageTaken.damage.total=-2147483648..2147483647}] if score @s rcubeAPI_damageTaken.UUID0 = $ender_dragon rcube_dragonRework.UUID0 if score @s rcubeAPI_damageTaken.UUID1 = $ender_dragon rcube_dragonRework.UUID1 if score @s rcubeAPI_damageTaken.UUID2 = $ender_dragon rcube_dragonRework.UUID2 if score @s rcubeAPI_damageTaken.UUID3 = $ender_dragon rcube_dragonRework.UUID3 run tag @s add dragon_rework.player.damaged_dragon

# Store damage totals (Utilises module 'damage_taken')
execute as @a[tag=dragon_rework.player.damaged_dragon] run scoreboard players operation @s rcube_dragonRework.death.damage.total = @s rcubeAPI_damageTaken.damage.total
...
execute if entity @a[advancements={rcube:dragon_rework/kill_dragon=true}] run data modify storage rcube:api/px_calc root.in.str set from storage rcube:api/player_name root.out.username
execute if entity @a[advancements={rcube:dragon_rework/kill_dragon=true}] run function rcube:api/px_calc/run
execute if entity @a[advancements={rcube:dragon_rework/kill_dragon=true}] store result score $px rcube_dragonRework.death.temp run data get storage rcube:api/px_calc root.out.px
...
execute if entity @a[advancements={rcube:dragon_rework/kill_dragon=true}] store result storage rcube:api/centre_string root.in.px int 1 run scoreboard players get $px rcube_dragonRework.death.temp
execute if entity @a[advancements={rcube:dragon_rework/kill_dragon=true}] run data modify storage rcube:api/centre_string root.in.manual set value true
execute if entity @a[advancements={rcube:dragon_rework/kill_dragon=true}] run function rcube:api/centre_string/run
execute as @a[advancements={rcube:dragon_rework/kill_dragon=true},limit=1] run tellraw @a[tag=dragon_rework.player.participated] ["",{"nbt":"root.out[].array","storage":"rcube:api/centre_string","interpret":true,"separator":""},{"nbt":"root.out.username","storage":"rcube:api/player_name","color":"dark_gray"},{"text":" dealt the final blow.","color":"gray"}]
...
data modify storage rcube:api/px_calc root.in.str set from storage rcube:api/player_name root.out.username
...
execute as @a[scores={rcube_dragonRework.death.damage.rank=1}] store result storage rcube:api/px_calc root.in.str int 1 run scoreboard players get @s rcube_dragonRework.death.damage.total
data modify storage rcube:api/px_calc root.in.str set string storage rcube:api/px_calc root.in.str
function rcube:api/px_calc/run
execute store result score $dmg rcube_dragonRework.death.temp run data get storage rcube:api/px_calc root.out.px
...
execute as @a[scores={rcube_dragonRework.death.damage.rank=1},limit=1] run tellraw @a[tag=dragon_rework.player.participated] ["",{"nbt":"root.out[].array","storage":"rcube:api/centre_string","interpret":true,"separator":""},{"text": "1st Damager","color": "yellow","bold": true},{"text": " - ","color": "gray"},{"nbt":"root.out.username","storage":"rcube:api/player_name","color":"gray"},{"text": " - ","color": "gray"},{"score": {"objective": "rcube_dragonRework.death.damage.total","name": "@s"},"color": "yellow"}]
...
function rcube:api/px_calc/run
execute store result score $px rcube_dragonRework.death.temp run data get storage rcube:api/px_calc root.out.px
execute as @a[scores={rcube_dragonRework.death.damage.rank=2}] store result storage rcube:api/px_calc root.in.str int 1 run scoreboard players get @s rcube_dragonRework.death.damage.total
data modify storage rcube:api/px_calc root.in.str set string storage rcube:api/px_calc root.in.str
function rcube:api/px_calc/run
execute store result score $dmg rcube_dragonRework.death.temp run data get storage rcube:api/px_calc root.out.px
scoreboard players operation $px rcube_dragonRework.death.temp += $dmg rcube_dragonRework.death.temp
...
data modify storage rcube:api/centre_string root.in.manual set value true
function rcube:api/centre_string/run
execute as @a[scores={rcube_dragonRework.death.damage.rank=2},limit=1] run tellraw @a[tag=dragon_rework.player.participated] ["",{"nbt":"root.out[].array","storage":"rcube:api/centre_string","interpret":true,"separator":""},{"text": "2nd Damager","color": "gold","bold": true},{"text": " - ","color": "gray"},{"nbt":"root.out.username","storage":"rcube:api/player_name","color":"gray"},{"text": " - ","color": "gray"},{"score": {"objective": "rcube_dragonRework.death.damage.total","name": "@s"},"color": "yellow"}]
...
function rcube:api/px_calc/run
execute store result score $px rcube_dragonRework.death.temp run data get storage rcube:api/px_calc root.out.px
execute as @a[scores={rcube_dragonRework.death.damage.rank=3}] store result storage rcube:api/px_calc root.in.str int 1 run scoreboard players get @s rcube_dragonRework.death.damage.total
data modify storage rcube:api/px_calc root.in.str set string storage rcube:api/px_calc root.in.str
function rcube:api/px_calc/run
execute store result score $dmg rcube_dragonRework.death.temp run data get storage rcube:api/px_calc root.out.px
scoreboard players operation $px rcube_dragonRework.death.temp += $dmg rcube_dragonRework.death.temp
...
data modify storage rcube:api/centre_string root.in.manual set value true
function rcube:api/centre_string/run
execute as @a[scores={rcube_dragonRework.death.damage.rank=3},limit=1] run tellraw @a[tag=dragon_rework.player.participated] ["",{"nbt":"root.out[].array","storage":"rcube:api/centre_string","interpret":true,"separator":""},{"text": "3rd Damager","color": "red","bold": true},{"text": " - ","color": "gray"},{"nbt":"root.out.username","storage":"rcube:api/player_name","color":"gray"},{"text": " - ","color": "gray"},{"score": {"objective": "rcube_dragonRework.death.damage.total","name": "@s"},"color": "yellow"}]
execute if entity @a[scores={rcube_dragonRework.death.damage.rank=-2147483648..2147483647}] run tellraw @a[tag=dragon_rework.player.participated] ""
