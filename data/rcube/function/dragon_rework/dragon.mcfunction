...
execute if entity @s[tag=dragon_rework.attacks.timer] if entity @a[predicate=rcube:dragon_rework/end_centre] run scoreboard players remove @s rcube_dragonRework.timer.attacks 1
execute if entity @s[scores={rcube_dragonRework.timer.attacks=0}] if entity @a[predicate=rcube:dragon_rework/end_centre] run function rcube:dragon_rework/attacks/run
execute if entity @s[tag=!dragon_rework.MAD,tag=!dragon_rework.UNHINGED] if entity @s[scores={rcube_dragonRework.timer.attacks=..0}] if entity @a[predicate=rcube:dragon_rework/end_centre] run scoreboard players set @s rcube_dragonRework.timer.attacks 400
execute if entity @s[tag=dragon_rework.MAD,tag=!dragon_rework.UNHINGED] if entity @s[scores={rcube_dragonRework.timer.attacks=..0}] if entity @a[predicate=rcube:dragon_rework/end_centre] run scoreboard players set @s rcube_dragonRework.timer.attacks 200
execute if entity @s[tag=dragon_rework.UNHINGED] if entity @s[scores={rcube_dragonRework.timer.attacks=..0}] if entity @a[predicate=rcube:dragon_rework/end_centre] run scoreboard players set @s rcube_dragonRework.timer.attacks 150
...
execute as @e[tag=dragon_rework.endZombie.temp,tag=!dragon_rework.UNHINGED,tag=!dragon_rework.endZombie.healthDone] unless score @s rcube_dragonRework.temp matches 19750.. run data merge entity @s {attributes:[{id:"max_health",base:25}]}
execute as @e[tag=dragon_rework.endZombie.temp,tag=!dragon_rework.UNHINGED,tag=!dragon_rework.endZombie.healthDone] if score @s rcube_dragonRework.temp matches 19750.. run data merge entity @s {Health:25f,attributes:[{id:"max_health",base:25}]}
execute as @e[tag=dragon_rework.endZombie.temp,tag=dragon_rework.UNHINGED,tag=dragon_rework.endZombie.healthDone] unless score @s rcube_dragonRework.temp matches 24750.. run data merge entity @s {attributes:[{id:"max_health",base:30}]}
execute as @e[tag=dragon_rework.endZombie.temp,tag=dragon_rework.UNHINGED,tag=dragon_rework.endZombie.healthDone] if score @s rcube_dragonRework.temp matches 24750.. run data merge entity @s {Health:30f,attributes:[{id:"max_health",base:30}]}
execute as @e[tag=dragon_rework.endZombie.temp,tag=dragon_rework.UNHINGED,tag=!dragon_rework.endZombie.healthDone] unless score @s rcube_dragonRework.temp matches 19750.. run data merge entity @s {attributes:[{id:"max_health",base:30}]}
execute as @e[tag=dragon_rework.endZombie.temp,tag=dragon_rework.UNHINGED,tag=!dragon_rework.endZombie.healthDone] if score @s rcube_dragonRework.temp matches 19750.. run data merge entity @s {Health:30f,attributes:[{id:"max_health",base:30}]}
...
# Remove boats
execute as @e[type=#rcube:dragon_rework/boat] at @s run function rcube:dragon_rework/boat_removal/type
